...
export class TelegramUserController {
  ...
  static async getUsersByRole(req: Request, res: Response) {
    try {
      ...
      logger.error('Error getting telegram users by role', error);
      res.status(500).json({
        success: false,
  ...
  static async getUserByChatId(req: Request, res: Response) {
    try {
      ...
      logger.error('Error getting telegram user by chat_id', error);
      res.status(500).json({
        success: false,
  ...
  static async getStats(req: Request, res: Response) {
    try {
      ...
      logger.error('Error getting telegram users stats', error);
      res.status(500).json({
        success: false,
