...
const PUBLIC_ROUTE_RULES: PublicRouteRule[] = [
  ...
  { method: 'GET', path: /^\/api\/design-assets\/public\/?$/ },
  { method: 'GET', path: /^\/api\/design-assets\/public\/list\/?$/ },
  { method: 'GET', path: /^\/api\/design-assets\/public\/[0-9]+\/content\/?$/ },
  { method: 'GET', path: /^\/api\/design-assets\/public\/[0-9]+\/thumb\/?$/ },
