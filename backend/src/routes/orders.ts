...
router.post('/:id/transfer', asyncHandler(OrderController.transferOrder))
...
router.post('/:id/issue', asyncHandler(async (req, res) => {
  ...
  // prepaymentUpdatedAt = дата выдачи для офлайн; online/telegram сохраняем (иначе безнал → касса).
