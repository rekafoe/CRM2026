/**
 * Статичная разметка тела аккордеона «Срочно / Промо» в калькуляторе Mini App.
 * Только внутренняя HTML-вставка (без <details>).
 */
export const MINIAPP_PRICE_TYPE_HELP_INNER_HTML = `
