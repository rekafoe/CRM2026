...
/** Вектор тот же, что в `backend/src/utils/byCurrencyBYN.ts` (экспорт Corel, один path). */
const BYN_PATH_D =
...
export const BynSymbol: React.FC<BynSymbolProps> = ({
  ...
  >
    <svg
      className="byn-sign__svg"
      viewBox="0 0 3780 5315.63"
      focusable="false"
      aria-hidden
    >
      <path className="byn-sign__path" d={BYN_PATH_D} fill="currentColor" />
    </svg>
  </span>
);
