...
export const DesignTemplatesPage: React.FC = () => {
  ...
  const catalogPath = '/adminpanel/design-templates';
              ...
              return (
                <div key={t.id} className="design-template-card">
                  ...
                  <div className="design-template-actions">
                    <button type="button" onClick={() => navigate(`${editorPathPrefix}/${t.id}`)} className="btn-open" title="Открыть админский редактор шаблона">
                      <AppIcon name="edit" size="xs" /> Шаблон
                    </button>
                    <button type="button" onClick={() => navigate(`/adminpanel/public-design-editor-preview/${t.id}`)} className="btn-open" title="Проверить клиентский экземпляр">
