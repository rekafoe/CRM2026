/**
 * Срок готовности заказа (Order Pool).
 * Держать в синхроне с backend/src/utils/orderReadySla.ts
 *
...
export function isHourSlaLabel(label: string): boolean {
  return /час/i.test(label);
}
