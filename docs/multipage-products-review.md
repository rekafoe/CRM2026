...
- **Печать**  
  ...
  Диапазон tier выбирается по **multipagePrintUnits**, не только по числу листов.  
  **Стоимость печати = unit_price × multipagePrintUnits** (эквивалентно полной цене за физический лист SRA3 × число листов).
