...
| 3. Галерея макетов | Сайт | `GET /api/design-templates/public` + `preview_url` |
...
flowchart LR
  ...
  screen3 --> cards[Карточки_preview_url]
...
sequenceDiagram
  ...
  SiteApi-->>Browser: id name preview_url category
