...
### Политика продуктов и расчёта (актуально)
...
*Диаграмма сохранена для контекста; при текущей политике расчёт для каталога идёт только в **`SimplifiedPricingService`** (см. таблицу «Политика продуктов и расчёта» выше). Узлы Flexible/Legacy не следует использовать при проектировании новых возможностей.*
